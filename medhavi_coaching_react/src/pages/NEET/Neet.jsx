...
import QuestionsCSS from '../NEET/HomeFeed.module.css';
...
const GetQuestionAnswers =()=>{
    ...
    const [defaultExamType,setdefaultExamType] = useState("NEET");
    const [defaultSubType,setdefaultSubType] = useState("Biology");
